...
Game.prototype.initMap = function () {
  ...
  var pj = this.characters[this.currentCharacterIdx];
  ...
  map.addListener('knightHero', function(){
    alert('Has elegido al Caballero');
    this.currentCharacterIdx = 1;
    this.completed = true;
  }.bind(this));

  map.addListener('pusheen', function(){
    alert('Has elegido al Nyancat');
    this.currentCharacterIdx = 2;
    this.completed = true;
  }.bind(this));

  map.addListener('nyancat', function(){
    alert('Has elegido al Pusheen');
