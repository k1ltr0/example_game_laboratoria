...
Game.prototype.initMap = function () {
  ...
  map.addListener('selectedKnight', function (personaje) {
    alert('You selected Knight');
    this.completed = true;
    this.currentCharacterIdx = 1;
  }.bind(this));

  map.addListener('selectedBrawly', function (personaje) {
    alert('You selected Brawly');
    this.completed = true;
    this.currentCharacterIdx = 2;
  }.bind(this));

  map.addListener('selectedRita', function (personaje) {
    alert('You selected Rita');
    this.completed = true;
